...
export const run: CallbackFunction = async (client, oldGuild: Guild, newGuild: Guild) => {
	const channela = newGuild.channels.cache.find(ch => !oldGuild.channels.cache.has(ch.id));
